...
export function startupServiceFactory(appLoadService: AppLoadService): Function {
...
@NgModule({
  ...
  providers: [
    AppLoadService,
    { provide: APP_INITIALIZER, useFactory: startupServiceFactory, deps: [AppLoadService], multi: true },
    GenericTooltipComponent,
    AuthGuard,
    ChatService,
