            ...
            messages: [
              {
                ...
                message:
                  'You are already logged in. If you would like to log out, type <i>"logout"</i>.',
              },
            ],
          },
          true
        ...
        this.chatService.addMessage(
          {
            ...
            messages: [
              {
                type: MessagePartType.HIGHLIGHT,
                message: `Attempting to to login`,
              },
            ],
          },
          true
        );
        this.chatService.setQuestionPending(true);
        this.chatService.notifyAnswer();
        this.loading = false;
            ...
            messages: [
              {
                type: MessagePartType.HIGHLIGHT,
                message:
                  'You cannot logout because you\'re not currently authenticated. If you would like to log in, type <i>"login"</i>.',
              },
            ],
          },
          true
